...
3) Access the `workbench` named `test-newk8ssa-feb-11-2-notebook`.
...
5) In the terminal, run `cd test-newk8ssa-feb-11-2` to navigate to your sample app's directory.
